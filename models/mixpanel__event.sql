...
dupes as (
    ...
    select 
        ...
        *,
        ...
        row_number() over(partition by insert_id, people_id, event_type, date_day {{ fivetran_utils.partition_by_source_relation(package_name='mixpanel') }} order by mp_processing_time_ms asc) as nth_event_record
